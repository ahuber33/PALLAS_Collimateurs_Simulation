...
```
- **alias** defines some values with YParticleGenerationOffset which depends on the 4 precedent values. Necessary to be used in macro Script bash
...
- 8 Trees can be created in the **BeginOfRunAction** :
