...
const G4String PALLAS_CollSimMaterials::path = "../simulation_input_files/";
...
PALLAS_CollSimMaterials::PALLAS_CollSimMaterials(G4String prop_buildfile) : bs_glass(0),
																			scintillator(0),
																			Vacuum(0),
																			plastic(0),
																			mylar(0),
...
PALLAS_CollSimMaterials::~PALLAS_CollSimMaterials()
{
	if (scintillator)
	{
		delete scintillator;
...
void PALLAS_CollSimMaterials::Construct()
{
...
G4Material *PALLAS_CollSimMaterials::GetMaterial(G4String material)
{
